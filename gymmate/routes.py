...
@login_required
def client():
	print("-------------Web Cam is Accessed----------------")
	print("-----------------Video is being Recorded-----------------------")
	print("--------------Web Template is going to be rendered after finishing---------------")
	call(["python","gymmate/client.py"])
	return render_template('sending.html',title='Wait')